        ...
        <AppBar>
          <a style={{ color: 'inherit', textDecoration: 'inherit' }} href="/">
            <Heading level="3" margin="none">
              Hospital Management System <i class="fas fa-hospital-user"></i>
            </Heading>
          </a>
        </AppBar>
            ...
            onSubmit={({ value }) => {
              ...
              fetch('http://localhost:3001/userInSession')
                ...
                .then((res) => {
                  ...
                  fetch(
                    'http://localhost:3001/checkIfApptExists?email=' +
                      email_in_use +
                      '&startTime=' +
                      theTime +
                      '&date=' +
                      ...
                      if (res.data[0]) {
                        ...
                        fetch('http://localhost:3001/genApptUID')
                          ...
                          .then((res) => {
                            ...
                            console.log(gen_uid)
                            fetch(
                              'http://localhost:3001/schedule?time=' +
                                theTime +
                                '&endTime=' +
                                endTime +
                                '&date=' +
                              ...
                              fetch(
                                'http://localhost:3001/addToPatientSeeAppt?email=' +
                                  email_in_use +
                                  '&id=' +
                                  gen_uid +
                                  '&concerns=' +
